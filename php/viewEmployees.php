...
include ('menu.html');
$query = "SELECT First_Name, Last_Name, IRS, Street, City,
    Street_Number, Postal_Code, Driver_License FROM Employee";
...
if($response){
    echo '<table align = "left" cellscpacing = "5" cellpadding = "8">
        ...
        <td align="left"><b>Driver License</b></td></tr>';
